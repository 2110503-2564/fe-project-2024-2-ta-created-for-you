...
export default async function UserInfo() {
    ...
    <div className="dark:bg-gray-900 m-10 px-10 py-5 text-xl flex flex-col gap-y-4 border-2 border-gray-500 shadow-lg font-bold">
    ...
    return (
        <div className="dark:bg-gray-900 w-[50%] my-10 mx-auto px-10 py-5 text-xl flex flex-col gap-y-4 border-2 border-gray-500 shadow-lg font-bold">
